...
//        {
//            if (GameManager.localInstance.calibrationMode && NetworkServer.active)
//            {
//                // If player not in data list
//                if (!GameManager.localInstance.playerVectorCalibDataList.Exists(x => x.playerName == playerName))
//                {
//                    // Add new entry of player
//                    GameManager.localInstance.playerVectorCalibDataList.Add(new PlayerVectorCalibData(playerName));
//                    // Add the name and first point to the data
//                    GameManager.localInstance.playerVectorCalibDataList.Find(x => x.playerName == playerName).point1 = pointData;
//                }
//                // If player exist but missing second point data
//                else if (GameManager.localInstance.playerVectorCalibDataList.Find(x => x.playerName == playerName).point2 == Vector3.zero)
//                {
